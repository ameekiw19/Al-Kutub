...
class AdminKitabController extends Controller
{
    ...
    public function AddKitab(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('admin.kitab.index')->with('success', 'Kitab berhasil ditambahkan! ' . $transcriptNotice);
    ...
    public function updateKitab(Request $request, $id_kitab)
    {
        try {
            ...
            return redirect()->route('admin.kitab.index')->with('success', $message);
        } catch (\Illuminate\Validation\ValidationException $e) {
            return redirect()->back()
                ->withInput()
                ->withErrors($e->errors())
    ...
    public function DeleteKitab($id_kitab)
    {
        try {
            ...
            return redirect()->route('admin.kitab.index')->with('error', 'Gagal menghapus kitab. Silakan coba lagi.');
        }
    }
